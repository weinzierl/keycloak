...
public class SAMLAggregateEndpoint {
    ...
    protected SAMLAggregateIdentityProvider provider;
    protected SAMLIdpDescriptor idpDescriptor;
    ...
    public SAMLAggregateEndpoint(RealmModel realm, SAMLAggregateIdentityProvider provider, SAMLAggregateIdentityProviderConfig config, IdentityProvider.AuthenticationCallback callback, DestinationValidator destinationValidator, SAMLIdpDescriptor idpDescriptor) {
        this.realm = realm;
        this.config = config;
    ...
    protected abstract class Binding {
        ...
        private String getEntityId(UriInfo uriInfo, RealmModel realm) {
            ...
            return UriBuilder.fromUri(uriInfo.getBaseUri()).path("realms").path(realm.getName()).path(providerAlias).build().toString();
        }
        ...
        private AuthenticationSessionModel samlIdpInitiatedSSO(final String clientUrlName) {
            ...
            SamlService samlService = (SamlService) factory.createProtocolEndpoint(SAMLAggregateEndpoint.this.realm, event);
