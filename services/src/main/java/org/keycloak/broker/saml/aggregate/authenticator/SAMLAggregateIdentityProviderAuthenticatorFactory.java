...
public class SAMLAggregateIdentityProviderAuthenticatorFactory implements AuthenticatorFactory, DisplayTypeAuthenticatorFactory {
    ...
    public Authenticator create(KeycloakSession session) {
        return new SAMLAggregateIdentityProviderAuthenticator();
    }

    @Override
    public Authenticator createDisplay(KeycloakSession session, String displayType) {
        if (displayType == null) return new SAMLAggregateIdentityProviderAuthenticator();
