...
public class IdentityProviderTest extends AbstractAdminTest {
    ...
    public void testMapperTypes() {
        ...
        mapperTypes = provider.getMapperTypes();
        assertMapperTypes(mapperTypes, "saml-user-attribute-idp-mapper", "saml-role-idp-mapper", "saml-username-idp-mapper", "saml-advanced-role-idp-mapper", "saml-javascript-idp-mapper");
    }
