...
public class KcSamlSignedLogoutOnlyBrokerTest extends AbstractBrokerTest {
    ...
    public static class KcSamlSignedBrokerConfiguration extends KcSamlBrokerConfiguration {
        ...
        public IdentityProviderRepresentation setUpIdentityProvider(IdentityProviderSyncMode syncMode) {
            ...
            config.put("wantLogoutRequestsSigned", "true");
    ...
    protected BrokerConfiguration getBrokerConfiguration() {
        return KcSamlSignedDocumentOnlyBrokerTest.KcSamlSignedBrokerConfiguration.INSTANCE;
    }
