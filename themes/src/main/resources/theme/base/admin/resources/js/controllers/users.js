...
module.controller('UserFederatedIdentityCtrl', function($scope, $location, realm, user, identityProvidersList, federatedIdentities, UserFederatedIdentity, Notifications, Dialog, $translate) {
...
module.controller('UserFederatedIdentityAddCtrl', function($scope, $location, realm, user, identityProvidersList, federatedIdentities, UserFederatedIdentity, Notifications, $translate) {
	realm.identityProviders = identityProvidersList;
	$scope.realm = realm;
    $scope.user = user;
