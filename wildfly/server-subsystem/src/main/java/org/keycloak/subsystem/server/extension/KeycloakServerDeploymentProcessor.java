...
public class KeycloakServerDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    private static final String[] CACHES = new String[] {
        "realms", "idps", "idpMappers", "users","sessions","authenticationSessions","offlineSessions","clientSessions","offlineClientSessions","loginFailures","work","authorization","keys","actionTokens"
    };
